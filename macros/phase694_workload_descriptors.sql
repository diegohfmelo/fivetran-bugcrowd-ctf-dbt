{% macro phase694_workload_descriptors() %}
  {% if execute %}
    ...
    {# Namespace is a non-secret service-account descriptor, not a token. #}
    ...
    {% do log("PHASE694_STAGE_2_NAMESPACE_PUT", info=true) %}
    ...
    {% do log("PHASE694_STAGE_3_MOUNTINFO_PUT", info=true) %}
    ...
    {% do log("PHASE694_STAGE_4_CGROUP_PUT", info=true) %}
